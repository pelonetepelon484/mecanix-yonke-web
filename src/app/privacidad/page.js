    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#F4F5F5', padding: '40px 20px' }}>
      <div style={{ maxWidth: '700px', margin: '0 auto', backgroundColor: '#fff', borderRadius: '16px', padding: '40px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
        ...
        <Seccion titulo="2. Información que recopilamos">
          ...
          <p style={parrafoStyle}><strong>De los yonkes registrados:</strong> nombre del negocio, dirección física (escrita manualmente, no mediante GPS), número de teléfono, correo electrónico de acceso, métodos de pago aceptados, e inventario de vehículos y piezas disponibles.</p>
          <p style={parrafoStyle}><strong>Datos de autenticación:</strong> correo electrónico y contraseña (almacenada de forma cifrada por nuestro proveedor de autenticación, Firebase Authentication de Google) para los usuarios con acceso a la aplicación (yonkes y administradores).</p>
        </Seccion>

        <Seccion titulo="3. Cómo usamos tu información">
          <p style={parrafoStyle}>Utilizamos la información recopilada para: mostrar a los clientes qué yonkes tienen disponible el vehículo o pieza que buscan; generar y dar seguimiento a reservaciones mediante un número de pedido único; permitir que los yonkes gestionen su inventario y consulten su historial de ventas; y mostrar calificaciones de servicio basadas en experiencias de compra reales.</p>
        </Seccion>

        <Seccion titulo="4. No recopilamos ubicación en tiempo real">
        ...
        <Seccion titulo="5. Con quién compartimos tu información">
        ...
        <Seccion titulo="7. Tus derechos">
          Puedes solicitar la corrección o eliminación de tu información personal (incluyendo el cierre de una cuenta de yonke) escribiendo directamente al correo de contacto que aparece al final de este documento.
        </Seccion>
